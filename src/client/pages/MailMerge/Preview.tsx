...
export const Preview: React.FC<PreviewProps> = ({ mailingList, template, schedule, scheduleType }) => {
  return (
    <Card>
      <Typography.Title
        level={4}
        style={{ color: "#595959", margin: 0, flex: "0 0", fontWeight: 300, marginBottom: 16 }}
      >
        Preview
      </Typography.Title>
